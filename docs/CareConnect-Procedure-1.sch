...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      <sch:assert test="count(f:extension[@url = 'https://hl7.org.uk/fhir/StructureDefinition/Extension-CareConnect-AnaestheticIssues-1']) &lt;= 1">extension with URL = 'https://hl7.org.uk/fhir/StructureDefinition/Extension-CareConnect-AnaestheticIssues-1': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:notDone) &lt;= 1">notDone: maximum cardinality of 'notDone' is 1</sch:assert>
      <sch:assert test="count(f:notDoneReason) &lt;= 1">notDoneReason: maximum cardinality of 'notDoneReason' is 1</sch:assert>
