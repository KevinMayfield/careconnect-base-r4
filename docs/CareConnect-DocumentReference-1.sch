...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DocumentReference">
      ...
      <sch:assert test="count(f:created) &lt;= 1">created: maximum cardinality of 'created' is 1</sch:assert>
      <sch:assert test="count(f:indexed) &gt;= 1">indexed: minimum cardinality of 'indexed' is 1</sch:assert>
      <sch:assert test="count(f:indexed) &lt;= 1">indexed: maximum cardinality of 'indexed' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:DocumentReference/f:context/f:related">
      ...
      <sch:assert test="count(f:ref) &lt;= 1">ref: maximum cardinality of 'ref' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
