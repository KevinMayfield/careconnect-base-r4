...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Medication">
      <sch:assert test="count(f:isBrand) &lt;= 1">isBrand: maximum cardinality of 'isBrand' is 1</sch:assert>
      <sch:assert test="count(f:isOverTheCounter) &lt;= 1">isOverTheCounter: maximum cardinality of 'isOverTheCounter' is 1</sch:assert>
      <sch:assert test="count(f:package) &lt;= 1">package: maximum cardinality of 'package' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>f:Medication/f:package/f:content</sch:title>
